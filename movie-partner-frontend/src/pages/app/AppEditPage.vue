<template>
  <div id="appEditPage">
    ...
    <div class="edit-container">
      <BaseCard title="基本信息" :loading="loading">
        <a-form
          :model="formData"
          :rules="rules"
          layout="vertical"
        ...
        >
          ...
          >
            ...
            <div v-if="formData.cover" class="cover-preview">
              <a-image
                :src="normalizeImageUrl(formData.cover)"
                :width="200"
                :height="150"
          ...
          <a-form-item>
            <a-space>
              <AppButton type="primary" html-type="submit" :loading="submitting">
                保存修改
              </AppButton>
              <AppButton @click="resetForm">重置</AppButton>
              <AppButton type="link" @click="goToChat">进入对话</AppButton>
            </a-space>
          </a-form-item>
        </a-form>
      </BaseCard>
      ...
      <!-- 应用信息展示 -->
      <BaseCard title="应用信息" style="margin-top: 24px">
        <a-descriptions :column="2" bordered>
          ...
          <a-descriptions-item label="访问链接">
            <AppButton v-if="appInfo?.deployKey" type="link" @click="openPreview" size="small">
              查看预览
            </AppButton>
...
import { AppButton, BaseCard } from '@/components/common'
import { getUserAvatarUrl, normalizeImageUrl } from '@/utils/imageUrl'
...
#appEditPage {
  ...
  max-width: var(--page-max-width-medium);
  margin: 0 auto;
}
